# Blog from Simon Goldsmith - coachciso.com

This repo contains the blog from [Simon Goldsmith](https://coachciso.com), both the blog application as well as the blog data.
